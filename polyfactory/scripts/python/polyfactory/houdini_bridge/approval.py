...
class ApprovalMode(Enum):
    ...
    DISABLED = "disabled"  # Never ask for approval (trusted AI agent)
...
class ApprovalManager:
    ...
    def __init__(self):
        self.mode = ApprovalMode.DISABLED  # Default to no approvals for AI agent
    ...
    def requires_approval(self, command_type: str, is_destructive: bool) -> bool:
        ...
        if self.mode == ApprovalMode.DISABLED:
            return False  # Never ask for approval
        elif self.mode == ApprovalMode.AUTO:
