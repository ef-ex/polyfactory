...
**STATUS (2026-08-22, after the third review round AND an independent verification pass, §11.8
P5V):** P0, P1, P2, P3, P5R **LANDED and VERIFIED**; P4 **DECLINED** with its measurement.
**P5 LANDED (§11.8 P5) and P6 DECLINED with its measurement (§11.8 P6, D109); ~~the only items that REMAIN~~** - both
cycles, both moving baselines by ~1e-6 m, and §11.5 risk 10 says re-measure before starting
either. P7 (bulk-read the miter glue) is untouched and was rated low priority. §11.8 is the log,
and it carries **corrected** figures for the P1 headline, P2's citygen label and P3's wall clock -
read those before quoting any number from this section.
...
### 11.8 Port build log — P0..P5R, and P5V's verification of them
...
So the deformed branch is not a corner of the tool. It is what conformed work is made of.
