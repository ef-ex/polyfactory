...
**Two registered mutations, both seen red.**

| id | runner | kills | measured |
|---|---|---|---|
| `default_slot_composed_again` | `hda` | `starter_fence_one_pillar_miter` | **0.111698 m**, 4 mixed-slot groups |
| `corner_style_composed_default` | `scene` | `double_pillar_m` | **19 cases red**, `V_rect_miter` at **0.111698 m** |

The first is the exact source-level undo of D266 (with the asset rebuilt). The second composes
