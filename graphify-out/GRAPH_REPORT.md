...
## Corpus Check
- 168 files · ~707,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4162 nodes · 6690 edges · 249 communities (230 shown, 19 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 361 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1768d941`
...
Cohesion: 0.13
Nodes (21): benches(), f32(), _fingerprint(), frame_calls(), frames_geometry(), frames_parity(), hilo(), mutation() (+13 more)
...
Cohesion: 0.13
Nodes (24): _clean(), decompose(), decompose_all(), _flag(), _native_cfg_matches(), polyChain 4.1 DECOMPOSE - a polyline becomes an ordered section list.  A SECTION, (kept original indices, positions, cumulative metres) - D8.      For a closed cu, Deviation from straight at `b`, in degrees. 0 = collinear. (+16 more)
...
Cohesion: 0.16
Nodes (19): check(), config_payload_parity(), decompose_parity(), main(), plan_benches(), r8_packed_transform(), D77 through the ASSET'S OWN `config` NODE, under a wired payload.      ⚠️ THE RI, Cook the native decompose chain on `case`'s own curve geometry. (+11 more)
...
Cohesion: 0.15
Nodes (17): 3.3's correlation key. A point number can never enter it., Deterministic across processes and sessions.      NOT builtin `hash()`: `PYTHO, scope_key(), seed_for(), _splitmix(), The strings the seeding chain is asked about, ~360 of them.      Three families, `text` as a VEX string literal.  ONE site - the plan solve needs it too., Cook `pc_rand.h` over `_seed_texts()`; -> {name: [values]}. (+9 more)
...
- **Why does `Node` connect `Community 78` to `Community 184`, `Community 72`, `Community 148`, `Community 87`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `Rule` connect `Community 149` to `Community 161`, `Community 229`, `Community 135`, `Community 8`, `Community 72`, `Community 138`, `Community 235`, `Community 76`, `Community 105`, `Community 211`, `Community 21`, `Community 54`, `Community 186`, `Community 188`?**
