...
## Corpus Check
- 124 files · ~163,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1725 nodes · 2660 edges · 108 communities (91 shown, 17 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 291 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ce13a8c`
...
Cohesion: 0.10
Nodes (19): dead_ends(), every_block_is_subdivided(), junction_boundary_is_simple(), no_downward_faces(), no_duplicate_lot_footprints(), no_loose_points(), no_scratch_attribs(), no_short_graph_segments() (+11 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (26): HoverComboBox, HoverSlider, Asset Browser Widgets - Low-level widget classes extracted from browser_ui.py., QSlider with animated hover outline, QComboBox with animated hover outline, AssetBrowserDialog, AssetBrowserWidget, AssetDropHandler (+18 more)
...
Cohesion: 0.14
Nodes (14): 4. Stage design, ⚠️ AREA WAS NOT ENOUGH EITHER. The fifth wrong seam — 2026-08-10, Chaotic / organic patterns — clarified, not scrapped, Layers — the change bridges force, Networks are typed, S0 — Domain, S1 — Field (pluggable generators), S3 — Graph (the contract, and the missing 80%) (+6 more)
...
Cohesion: 0.09
Nodes (12): Load assets from database, Filter assets based on search, category, and tags, Update grid with filtered assets, Forward thumbnail drop to the browser-level signal., Return the resolved path to the asset database., Delete all selected assets from the library database (Delete key)., Show a context menu on right-click.  If the clicked asset is not already, Open a dialog to bulk-add or bulk-remove tags on the current selection. (+4 more)
...
Cohesion: 0.14
Nodes (7): AssetExportDialog, Dialog for exporting selected geometry to asset library, Load existing categories from database, Handle name confirmation (Enter key or lost focus) - auto-suggest category and t, Update the export path preview, Handle export button click, Get the export configuration data
...
Cohesion: 0.14
Nodes (16): attribute_schema(), graph_is_planar(), hou_vec3(), lot_clip_control_rig(), lots_are_simple_polygons(), no_orphan_components(), no_scratch_groups(), CityGen geometry checks — the assertions, in one place.  Every check here caught (+8 more)
...
Cohesion: 0.33
Nodes (4): _handle_drop(), Double-click in the floating browser: create and connect the         asset plac, Called after a drag completes. If the cursor is outside our own         window,, Create a pf_asset_place node in the current network, wire it to the         cur
...
- **Why does `PyPushButton` connect `Community 8` to `Community 32`, `Community 65`, `Community 36`, `Community 72`, `Community 78`, `Community 47`, `Community 85`, `Community 22`, `Community 90`, `Community 63`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `HoverOutlineMixin` connect `Community 32` to `Community 34`, `Community 36`, `Community 38`, `Community 8`, `Community 78`, `Community 15`, `Community 22`, `Community 90`, `Community 91`, `Community 63`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 7` to `Community 71`, `Community 104`, `Community 74`, `Community 43`, `Community 76`, `Community 86`, `Community 88`, `Community 89`?**
