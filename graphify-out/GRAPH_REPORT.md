...
## Corpus Check
- 122 files · ~106,062 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1596 nodes · 2443 edges · 99 communities (86 shown, 13 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 290 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ca72f41`
...
Cohesion: 0.12
Nodes (16): 10. Explicit non-goals for v1, 1. Hard constraints, 2. Diagnosis: why the previous attempts produced unsatisfying output, 3. Architecture: staged pipeline with schema contracts, 4c. Implementation status — 2026-08-09, 4d. Measured state of the shipped build — 2026-08-09 (pre-fix), 4e. Independent audit findings — 2026-08-09, 4f. Civil-engineering sweep — 2026-08-09. What it changes (+8 more)
...
## Knowledge Gaps
- **269 isolated node(s):** `Project Overview`, `Package Structure`, `Environment Variables`, `Temporary / One-Off Scripts`, `Houdini Bridge - AI Agent Integration` (+264 more)
...
- **Why does `PyPushButton` connect `Community 92` to `Community 0`, `Community 97`, `Community 36`, `Community 69`, `Community 6`, `Community 72`, `Community 77`, `Community 78`, `Community 47`, `Community 83`, `Community 85`, `Community 88`, `Community 58`?**
