...
## Corpus Check
- 166 files · ~679,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4013 nodes · 6396 edges · 247 communities (231 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 352 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `570690e4`
...
Cohesion: 0.15
Nodes (24): benches(), check(), decompose_parity(), f32(), frame_calls(), frames_geometry(), frames_parity(), main() (+16 more)
...
Cohesion: 0.05
Nodes (47): arc_points(), broken_kit(), build_all(), build_with_payload(), bump(), camber_z(), _case(), coarse_kit() (+39 more)
...
Cohesion: 0.08
Nodes (18): HoverComboBox, HoverSlider, Asset Browser Widgets - Low-level widget classes extracted from browser_ui.py., QSlider with animated hover outline, Draw widget with selection highlight and animated hover outline., QComboBox with animated hover outline, AssetBrowserDialog, AssetDropHandler (+10 more)
...
Cohesion: 0.15
Nodes (21): _clean(), decompose(), decompose_all(), _flag(), polyChain 4.1 DECOMPOSE - a polyline becomes an ordered section list.  A SECTION, (kept original indices, positions, cumulative metres) - D8.      For a closed cu, Deviation from straight at `b`, in degrees. 0 = collinear., Every vertex that is a corner, in point order (4.1).      `pc_corner`: -1 suppre (+13 more)
...
Cohesion: 0.13
Nodes (19): analyse(), _blank_to_none(), _cross(), Override, _override_for(), _pattr(), plan_points(), _prattr() (+11 more)
...
Cohesion: 0.20
Nodes (9): config_stub(), feed(), The NATIVE stage chain, built as real SOP nodes, for the parity harness.      13, One Attribute Wrangle, its VEX inlined from the .vfl of the same name.      `vex, 4.1 - arclength, the curve-id table, corners, markers.      Returns (last node,, A `file` SOP serving `geometry` - the rig's way of putting a     `hou.Geometry`, The CONFIG stream, until 13.3.0's Python SOP exists: one detail point     carryi, stage_decompose() (+1 more)
...
Cohesion: 0.11
Nodes (19): duplicate_curve_ids(), heightfield(), polyline(), TWO CURVES AUTHORED WITH ONE `pc_curve_id` - D74's control build.      ⚠️ NOT, The same case with an UNRELATED curve merged into input 1.      3.4's id rule, THE SAME CASE DRIVEN BY A 3.3 STYLE PAYLOAD instead of by its `Style`.      Th, 200 x 2 m panels on a 400 m straight - PC-G3's shape, small enough to     run i, The same panels on a 10 m-radius arc - 100 % DEFORMED, the branch     `tripwire (+11 more)
...
Cohesion: 0.22
Nodes (14): cook(), feeds(), main(), polyfactory_sops(), published(), Attribute hygiene for every polyfactory HDA, in a throwaway Houdini session., Every name on one output, by class., The law: nothing named `_*` may leave. (+6 more)
...
Cohesion: 0.50
Nodes (4): curve_prim_index(), plan_geometry(), {curve id: primitive number} using `pc_curveid.vfl`'s OWN id rule.      D29 + D6, `plan_points` PLUS 13.3.4's frame inputs - the PLAN stage's output.      ⚠️ SCAF
...
- **Why does `Node` connect `Community 231` to `Community 184`, `Community 72`, `Community 148`, `Community 87`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `Rule` connect `Community 149` to `Community 161`, `Community 135`, `Community 8`, `Community 72`, `Community 105`, `Community 76`, `Community 211`, `Community 213`, `Community 21`, `Community 119`, `Community 54`, `Community 186`, `Community 188`?**
