...
## Corpus Check
- 131 files · ~355,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2262 nodes · 3278 edges · 160 communities (143 shown, 17 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 291 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ce975fb`
...
Cohesion: 0.08
Nodes (26): 0.0 BUILD STATE — resume pointer (read this first, keep it current), 0. Instructions to the implementing agent, 10. Build log, 1. Scope and non-goals, 2.1 The two-face principle (load-bearing), 2.2 Node family (working names; `pf_` per suite convention), 2.3 Chain SOP seed — gate PC-G0, 2. Architecture (+18 more)
...
Cohesion: 0.10
Nodes (5): PySlider, PyTitleBar, PyToggle, QCheckBox, QSlider
...
Cohesion: 0.08
Nodes (14): AssetInfoPanel, Handle resize to update preview image size, Create styled label for form, Load turntable frames for animation, Display a specific frame, Display asset information, Load full turntable sequence on hover, Return to frame 5 on leave (+6 more)
...
Cohesion: 0.13
Nodes (6): Params, The `s5j_params` values the corner solve reads. Defaults are the HDA's.      `re, Ui_RightColumn, Themes, object, Ui_MainPages
...
Cohesion: 0.12
Nodes (4): Functions, MainFunctions, SetupMainWindow, UI_MainWindow
...
Cohesion: 0.15
Nodes (9): AssetInstanceWidget, createInterface(), Kitbash HDA UI - Python Panel interface for pf_kitbash node  NEW WORKFLOW: -, Create styled spinbox, Load values from node parameters, Handle spinbox value change, Widget representing a single placed asset instance, Entry point for Python Panel UI.     Called by Houdini when creating the interf (+1 more)
...
Cohesion: 0.17
Nodes (7): case_nodes(), load(), The S5 planner, calibrated against the builder's own plates. No Houdini.      py, The dumped case as planner data, plus the params the builder used., ⚠️ THE ASSERTION EVERYTHING DOWNSTREAM ACTUALLY RESTS ON.          Every metre i, ...and the size of the error, signed, because the two directions are         not, The assembly, not the corner — a different code path with its own way         to
...
Cohesion: 0.67
Nodes (3): 11.6 The re-route — one mechanism, two targets, The construction, SOLVED 2026-08-17 (M5.3's planner half), The mover SHIPPED 2026-08-17 — and the pipeline overruled the tangent
...
- **Why does `Node` connect `Community 24` to `Community 72`, `Community 3`, `Community 128`, `Community 87`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 7` to `Community 153`, `Community 101`, `Community 38`, `Community 71`, `Community 104`, `Community 72`, `Community 74`, `Community 43`, `Community 107`, `Community 86`, `Community 88`, `Community 89`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `HoverOutlineMixin` connect `Community 32` to `Community 35`, `Community 36`, `Community 105`, `Community 137`, `Community 106`, `Community 108`, `Community 78`, `Community 20`, `Community 119`, `Community 127`?**
