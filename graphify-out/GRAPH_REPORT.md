...
## Corpus Check
- 168 files · ~716,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4187 nodes · 6747 edges · 240 communities (227 shown, 13 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 366 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23248555`
...
Cohesion: 0.07
Nodes (48): _aabbs_overlap(), detect_asset_groups(), next_free_filename(), Batch Kitbash Importer - AABB-based asset detection and batch export backend, Find the next available numbered filename (no extension).      Scans both the, Detect asset groups in a SOP node using connectivity + AABB overlap.      Each, Return True if two AABBs (min_x,min_y,min_z,max_x,max_y,max_z) overlap., Read a string primitive attribute value; return default if absent. (+40 more)
...
Cohesion: 0.14
Nodes (8): bump(), camber_z(), malformed_payload(), A 3.3 payload with one distinct fault per rule, plus a junk meta dict.      Cook, A ridge NARROWER THAN A QUARTER OF A PIECE, on flat ground at y = -1.      D71's, Cross-fall: the surface tilts ACROSS the run, which is what camber is.     A run, hython has not loaded the polyfactory package, so scripts/python is not     on s, setup_env()
...
- **Why does `Rule` connect `Community 149` to `Community 161`, `Community 229`, `Community 231`, `Community 8`, `Community 72`, `Community 105`, `Community 235`, `Community 76`, `Community 135`, `Community 239`, `Community 211`, `Community 21`, `Community 54`, `Community 119`, `Community 186`, `Community 188`?**
...
- **Are the 38 inferred relationships involving `Rule` (e.g. with `build_all()` and `facade_style()`) actually correct?**
  _`Rule` has 38 INFERRED edges - model-reasoned connections that need verification._
