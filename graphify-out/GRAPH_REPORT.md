...
## Corpus Check
- 149 files · ~554,943 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3428 nodes · 5454 edges · 214 communities (200 shown, 14 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 316 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea010e50`
...
Cohesion: 0.06
Nodes (44): _band_case(), band_hybrid(), bank_adaptive(), _by_zmode(), cap_dressing(), conform_misses(), corner_reach(), corner_turns() (+36 more)
...
Cohesion: 0.06
Nodes (42): arc_points(), broken_kit(), build_all(), build_with_payload(), bump(), camber_z(), _case(), coarse_kit() (+34 more)
...
Cohesion: 0.16
Nodes (13): _add(), _assembly_placements(), Bevel, _mul(), _piece_span(), One solved corner. Angles in DEGREES at the boundary, radians inside.      `e_fo, D39, REVISED: there is exactly ONE cut plane and it NEVER MOVES.          The fi, (origin, normal, keep_sign) for the piece arriving at the vertex. (+5 more)
...
Cohesion: 0.20
Nodes (8): polyChain - the contracts the 1D kernel is written against. No `hou`.  Spec: `, Payload order preserved: the first rule that yields wins., 3.3's correlation key. A point number can never enter it., Deterministic across processes and sessions.      NOT builtin `hash()`: `PYTHO, scope_key(), seed_for(), _splitmix(), Style
...
Cohesion: 0.13
Nodes (10): object, CornerPiece, One module of the composed corner run, already resolved onto a leg., Corner, A break candidate at one polyline vertex. Angles in DEGREES.      `turn_angle` i, main(), Run every polyChain geometry check in a throwaway Houdini session.      hython, One case, read once - so a check never re-derives what another already     meas (+2 more)
...
Cohesion: 0.13
Nodes (21): axis_follows_curve(), axis_points(), _degenerate(), _dist_xz(), exact_fill(), _flat_in_y(), horizontal_spacing(), horizontal_span_is() (+13 more)
...
Cohesion: 0.13
Nodes (6): D10, and RailClone's own documented limit about the closing vertex:         a c, The square's fourth corner is AT point 0, which an open-curve         implement, D7: a per-POINT list is the only shape that can express a mid-curve         lim, D18: start/end modules cap a RUN. A corner is not the end of one -         Rail, square(), TestSections
...
Cohesion: 0.33
Nodes (4): The same case with the OVERRIDE input unwired - the control the swap     and re, hython has not loaded the polyfactory package, so scripts/python is not     on, rebuild_plain(), setup_env()
...
## Knowledge Gaps
- **707 isolated node(s):** `Project Overview`, `Package Structure`, `Environment Variables`, `Temporary / One-Off Scripts`, `Houdini Bridge - AI Agent Integration` (+702 more)
...
- **Why does `Node` connect `Community 203` to `Community 184`, `Community 154`, `Community 148`, `Community 87`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `PyPushButton` connect `Community 137` to `Community 3`, `Community 36`, `Community 72`, `Community 76`, `Community 23`, `Community 92`, `Community 61`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `Settings` connect `Community 100` to `Community 72`, `Community 154`, `Community 132`, `Community 175`?**
