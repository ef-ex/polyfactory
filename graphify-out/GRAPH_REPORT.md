...
## Corpus Check
- 146 files · ~495,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3241 nodes · 5167 edges · 205 communities (189 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 311 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6de9142a`
...
## Communities (205 total, 16 thin omitted)
...
Cohesion: 0.18
Nodes (14): _dot(), _len(), _probe_s(), polyChain 4.5 SURFACE CONFORM - input 4, the drape onto a surface.  4.5 in ful, Input 4, as one question: where does a point land when it is dropped?      THE, (position, normal, distance) of the first hit, or None., (position, normal, hit). A miss returns `p` unmoved (D53).          The normal, Does the drape between `sa` and `sb` leave the straight chord?          This i (+6 more)
...
Cohesion: 0.12
Nodes (9): Arm, Node, Params, The `s5j_params` values the corner solve reads. Defaults are the HDA's.      `re, One street as seen FROM a node: which end of it this is, and where it goes., object, Params, Every HDA parm the kernel reads. Angles in DEGREES (artist boundary).      `fi (+1 more)
...
Cohesion: 0.09
Nodes (29): _apply_cuts(), Assembly, _bevel_between(), build_assembly(), compose_modules(), _corner_rule(), CornerPiece, _default_module() (+21 more)
...
Cohesion: 0.08
Nodes (34): _area(), _attrs(), bank_adaptive(), _by_zmode(), _clip_convex(), collect_warns(), corner_wedge(), determinism() (+26 more)
...
Cohesion: 0.32
Nodes (3): ConformPath, A `place.Path` seen through the surface. Same interface, draped answers., Did any station across [sa, sb] fall off the surface?          `fracs` is THE
...
- **Why does `Node` connect `Community 161` to `Community 184`, `Community 83`, `Community 148`, `Community 87`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 7` to `Community 161`, `Community 101`, `Community 38`, `Community 71`, `Community 104`, `Community 74`, `Community 43`, `Community 107`, `Community 174`, `Community 86`, `Community 88`, `Community 89`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 108` to `Community 32`, `Community 161`, `Community 169`, `Community 204`, `Community 177`, `Community 179`, `Community 21`, `Community 156`?**
