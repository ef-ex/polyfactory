...
## Corpus Check
- 169 files · ~750,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4298 nodes · 6936 edges · 253 communities (237 shown, 16 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 373 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fbf09610`
...
## Communities (253 total, 16 thin omitted)
...
Cohesion: 0.08
Nodes (36): bench_guard_fallback(), check(), config_payload_parity(), frames_scale_check(), frames_scale_in_segments(), frames_scale_mutation(), main(), native_place_says_why_it_is_empty() (+28 more)
...
- **Why does `Node` connect `Community 234` to `Community 184`, `Community 201`, `Community 148`, `Community 239`?**
