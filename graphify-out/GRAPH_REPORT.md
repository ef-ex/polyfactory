...
## Corpus Check
- 122 files · ~114,911 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1610 nodes · 2464 edges · 97 communities (80 shown, 17 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 290 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b1e63cea`
...
Cohesion: 0.11
Nodes (15): attribute_schema(), dead_ends(), graph_is_planar(), no_downward_faces(), no_loose_points(), no_orphan_components(), no_scratch_groups(), Conformance with the schema table. Identity must survive to the final     geomet (+7 more)
...
Cohesion: 0.18
Nodes (3): Functions, Settings, PyTitleBar
...
Cohesion: 0.04
Nodes (47): 10. Explicit non-goals for v1, 1. Hard constraints, 2. Diagnosis: why the previous attempts produced unsatisfying output, 3. Architecture: staged pipeline with schema contracts, 3b. The unanimous baseline — where all four sources agree, 4. Stage design, 4c. Implementation status — 2026-08-09, 4d. Measured state of the shipped build — 2026-08-09 (pre-fix) (+39 more)
...
Cohesion: 0.07
Nodes (18): AssetInfoPanel, Handle resize to update preview image size, Create styled label for form, Load turntable frames for animation, Display a specific frame, Display asset information, Load full turntable sequence on hover, Return to frame 5 on leave (+10 more)
...
Cohesion: 0.23
Nodes (11): _blobs(), city_is_fully_paved(), lots_are_simple_polygons(), _raster_grid(), _rasterise(), CityGen geometry checks — the assertions, in one place.  Every check here caught, Even-odd fill of every polygon in `geo` onto a boolean XZ grid., Connected components of a boolean mask as (area, cx, cz), largest first.      Ru (+3 more)
...
Cohesion: 0.20
Nodes (4): object, Ui_MainPages, PyWindow, Styles
...
## Knowledge Gaps
- **273 isolated node(s):** `Project Overview`, `Package Structure`, `Environment Variables`, `Temporary / One-Off Scripts`, `Houdini Bridge - AI Agent Integration` (+268 more)
...
- **Why does `PyPushButton` connect `Community 18` to `Community 0`, `Community 32`, `Community 36`, `Community 38`, `Community 72`, `Community 8`, `Community 77`, `Community 78`, `Community 47`, `Community 20`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `HoverOutlineMixin` connect `Community 32` to `Community 0`, `Community 34`, `Community 36`, `Community 78`, `Community 15`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Result` connect `Community 7` to `Community 96`, `Community 71`, `Community 74`, `Community 43`, `Community 76`, `Community 86`, `Community 88`, `Community 89`, `Community 90`, `Community 92`?**
