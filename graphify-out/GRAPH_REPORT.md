...
## Corpus Check
- 149 files · ~564,563 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3457 nodes · 5510 edges · 212 communities (197 shown, 15 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 318 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `24efd417`
...
Cohesion: 0.15
Nodes (11): draw_normal_indicator(), Drawing utilities for viewer states Pure functions for viewport drawing helpers, Draw line indicating surface normal.          Args:         drawable: Houdini, Viewer utilities for Houdini viewer states Reusable library components for rayc, get_modifier_state(), is_click(), is_key_pressed(), Input handling utilities for viewer states Functions for processing mouse/keybo (+3 more)
...
Cohesion: 0.11
Nodes (21): deformed_flag_matches_geometry(), _degenerate(), _dist_xz(), exact_fill(), _flat_in_y(), horizontal_spacing(), horizontal_span_is(), _mitered() (+13 more)
...
Cohesion: 0.06
Nodes (33): cap_tagged(), curve_sample_scaling(), duplicate_curve_id_warns(), elem_ids_survive_upstream(), element_count(), element_resolution(), geometry_digest(), instancing_split() (+25 more)
...
Cohesion: 0.15
Nodes (15): export_batch_group(), Export a single asset group detected by detect_asset_groups.      Converts pri, acquire_shared_panel(), _cleanup(), _create_render_scene(), Turntable Renderer - Creates rotating preview animations for assets, Create a shared floating panel for batch renders.      Call once before starti, Render frames using viewport flipbook          Args:         lop_net: LOP net (+7 more)
...
Cohesion: 0.16
Nodes (20): axis_follows_curve(), _axis_of(), axis_points(), corner_clearance(), _element_frame(), _face(), frame_continuity(), _frame_of() (+12 more)
...
Cohesion: 0.14
Nodes (17): SQLite database management for asset library, _build_export_network(), _cleanup(), export_asset(), _export_geometry(), _get_geometry_stats(), _prims_to_group_string(), Asset Exporter - Builds node network and exports geometry (+9 more)
...
## Knowledge Gaps
- **710 isolated node(s):** `Project Overview`, `Package Structure`, `Environment Variables`, `Temporary / One-Off Scripts`, `Houdini Bridge - AI Agent Integration` (+705 more)
...
- **Why does `Node` connect `Community 42` to `Community 35`, `Community 203`, `Community 148`, `Community 87`, `Community 184`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `PyPushButton` connect `Community 137` to `Community 3`, `Community 36`, `Community 72`, `Community 175`, `Community 210`, `Community 23`, `Community 92`, `Community 61`?**
