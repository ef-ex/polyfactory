...
## Corpus Check
- 159 files · ~631,259 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3825 nodes · 6128 edges · 228 communities (214 shown, 14 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 350 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fbd31128`
...
Cohesion: 0.05
Nodes (56): arc_points(), broken_kit(), build_all(), build_with_payload(), bump(), _case(), coarse_kit(), compose_kit() (+48 more)
...
Cohesion: 0.05
Nodes (56): bend_deviation(), cap_dressing(), clip_inside(), conform_cache_per_element(), conform_misses(), conform_parity(), conform_prefetch_hit_rate(), corner_reach() (+48 more)
...
Cohesion: 0.10
Nodes (21): The blank box a missing module becomes. Never a failure (3.4)., stand_in(), _anchor_len(), _anchor_transform(), _band(), build(), _collate_warnings(), _declare() (+13 more)
...
Cohesion: 0.11
Nodes (26): _area_xz(), _attrib_values(), _expected_reject(), hou_vec3(), input0_reaches_an_output(), lot_aspect_ratio(), lot_clip_control_rig(), lots_are_simple_polygons() (+18 more)
...
Cohesion: 0.10
Nodes (19): The same modules, fitted on their HEIGHT. Data, not a second solver., transpose_kit(), elem_id(), Kit, kit_from_records(), Module, polyChain - the contracts the 1D kernel is written against. No `hou`.  Spec: `, One kit piece (3.2). `size` is the nominal FITTED size in metres. (+11 more)
...
Cohesion: 0.09
Nodes (27): area_frame(), area_rows(), AreaFrame, canonical_loop(), _cross3(), _dist(), _dot(), fallback_lines() (+19 more)
...
Cohesion: 0.12
Nodes (18): classify(), close_roles(), fallback_chain(), (kit, {role asked: role supplied}) - E3, pure data expansion.      Every cell, Stamp the 2D half of every placement of ONE row, and warn D118's walk.      ON, The ordered walk for a missing cell, 7.2.2.      `<x>_<y>` -> drop the Y class, canonical_role(), _is_slot() (+10 more)
...
Cohesion: 0.11
Nodes (18): _band_case(), band_datum(), band_hybrid(), _fill_span(), _groups(), `stepped_riser_m` as an ASSERTION, for the one case that needs it.      ⚠️ ADD, D99 - this case carries a top/bottom BAND, so every yaw-only piece in     it is, [(track, section, [placements in build order])] - the unit every     along-the- (+10 more)

### Community 179 - "Community 179"
Cohesion: 0.07
Nodes (40): _area(), _attrs(), bank_adaptive(), _by_zmode(), _clip_convex(), collect_warns(), _component_centres(), corner_wedge() (+32 more)

### Community 181 - "Community 181"
Cohesion: 0.29
Nodes (3): D55 - does THIS module take the surface camber?, Payload order preserved: the first rule that yields wins.          D119 - with, Style
...
Cohesion: 0.25
Nodes (8): _deform_positions(), _follows(), Every point of `src` re-read at its own arc position. Returns     (flat world p, D31 - the frame carried along the piece instead of re-derived per point., Does the point at local height `y` FOLLOW the ground? (D99)      One expressio, D98 - the ONE elevation a `stepped` piece sits flat at.      OFF (RailClone's, _stepped_base(), _transport()
...
Cohesion: 0.11
Nodes (6): polyChain 7 ARRAY2D - the row stack and the cell lattice. No Houdini.      pyt, 7.2.2 - the lattice walk, and why Y sheds first., D124 - ids survive re-authoring, or 12.7's identity rule is a wish., TestCanonicalFootprint, TestFallbackChain, TestNoHoudini
...
Cohesion: 0.23
Nodes (12): build(), close_kit(), _ensure(), polyChain 7 FACADE - the 2D adapter. Rows in, ONE `place.build`, out.  This is, (kit geometry with every 2D cell role resolved, {asked: supplied}).      A COP, 7.3.2's `pc_style_meta["y_params"]`, read by the SAME `params_from_dict`., One footprint + a height -> a facade. Returns (geometry, report).      `footpr, Only name a fallback a CELL ACTUALLY ASKED FOR. The lattice has 25     entries (+4 more)
...
Cohesion: 0.14
Nodes (8): camber_z(), malformed_payload(), A 3.3 payload with one distinct fault per rule, plus a junk meta dict.      Co, Cross-fall: the surface tilts ACROSS the run, which is what camber is.     A ru, TWO FACETS AND A CREASE - the surface coarser than the pieces (D56).      Buil, hython has not loaded the polyfactory package, so scripts/python is not     on, setup_env(), tent()
...
- **Why does `Node` connect `Community 83` to `Community 184`, `Community 194`, `Community 148`, `Community 87`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `Rule` connect `Community 149` to `Community 161`, `Community 194`, `Community 135`, `Community 8`, `Community 105`, `Community 76`, `Community 211`, `Community 21`, `Community 54`, `Community 119`, `Community 186`, `Community 188`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `PyPushButton` connect `Community 137` to `Community 3`, `Community 36`, `Community 100`, `Community 69`, `Community 72`, `Community 20`, `Community 23`, `Community 92`?**
